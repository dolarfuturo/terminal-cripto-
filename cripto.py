            ...
            if st.form_submit_button("LIBERAR ACESSO"):
                ...
                if not user_row.empty and str(p) == str(user_row.iloc[0]['password']).strip():
                    ...
                    if hoje > data_venc:
                        ...
                        st.markdown("<a href='https://t.me/SEU_SUPORTE' target='_blank'><button style='width:100%; background-color:#D4AF37; color:black; border:none; padding:10px; font-weight:bold; cursor:pointer;'>FALAR COM SUPORTE PARA RENOVAR</button></a>", unsafe_allow_html=True)
                    else:
        ...
        with placeholder.container():
            ...
            for tid, name in assets.items():
                try:
                    ...
                    # Acessando o último preço de fechamento e o primeiro de abertura com segurança
