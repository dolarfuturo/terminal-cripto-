...
# CSS FINAL - TÍTULO MAXIMIZADO + STICKY REFORÇADO
st.markdown("""
    <style>
    ...
    /* NOMES AUMENTADOS */
    .title-gold { color: #D4AF37; font-size: 42px; font-weight: 900; text-align: center; margin-top: 5px; line-height: 1.1; }
    .subtitle-white { color: #FFFFFF; font-size: 18px; text-align: center; letter-spacing: 6px; text-transform: lowercase; margin-bottom: 8px; font-weight: 300; }
    ...
    .row-container { display: grid; grid-template-columns: 1.5fr 1.2fr 1fr 1fr 1fr 1fr 1fr 1fr; width: 100%; align-items: center; padding:
