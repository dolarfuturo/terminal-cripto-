...
# 1. SETUP ALPHA - EXPANDIDO PARA 20 ATIVOS
            ...
            for t, info in COINS_CONFIG.items():
                ...
                st.markdown(f"""
                    ...
                    <div class="vision-block">
                        <div class="v-item"><div style="color:#888; font-size:9px;">RESETVISION</div><div style="color:#FFF; font-size:16px; font-weight:
