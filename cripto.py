    ...
    try:
        ...
        with placeholder.container():
            ...
            for tid, name in assets.items():
                try:
                    # Cálculo baseado na abertura (00:00 UTC) automático via yfinance fast_info
                    ...
                    # Alvos calculados por Desvios de Volatilidade
                    ...
                    if price >= v10: s_txt, s_class, v10_c = "EXAUSTÃO MÁXIMA", "bg-ex-red", "t-active t-r"
