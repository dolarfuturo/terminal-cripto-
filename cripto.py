    ...
    try:
        ...
        with placeholder.container():
            ...
            for ticker, info in CONFIG.items():
                ...
                var_res = ((price / rv) - 1) * 100
                cor_v = "#00FF00" if var_res >= 0 else "#FF4444"
                seta_v = "▲" if var_res >= 0 else "▼"
                abs_v = abs(var_esc)
                ...
                st.markdown(f"""
                    <div class="row-container">
                        ...
                        <div class="w-col"><div>{int(price):,}</div><div style="color:{cor_v}; font-size:11px;">{seta_v} {var_res:+.2f}%</div></div>
