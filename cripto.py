...
COINS_CONFIG = {
    ...
    "XRP-USD": {"label": "BNB/USDT", "dec": 2},
    "BNB-USD": {"label": "XRP/USDT", "dec": 4},
    "DOGE-USD": {"label": "DOGE/USDT", "dec": 4},
    "LINK-USD": {"label": "ADA/USDT", "dec": 4},
    "ADA-USD": {"label": "AVAX/USDT", "dec": 2},
    "AVAX-USD": {"label": "DOT/USDT", "dec": 2},
    "DOT-USD": {"label": "LINK/USDT", "dec": 2},
    "MATIC-USD": {"label": "POL/USDT", "dec": 4},
    "PEPE-USD": {"label": "TRX/USDT", "dec": 4},
    "SUI-USD": {"label": "LTC/USDT", "dec": 2},
    "NEAR-USD": {"label": "BCH/USDT", "dec": 2},
    "APT-USD": {"label": "SHIB/USDT", "dec": 6},
    "OP-USD": {"label": "NEAR/USDT", "dec": 3},
    "ARB-USD": {"label": "APT/USDT", "dec": 2},
    "INJ-USD": {"label": "UNI/USDT", "dec": 2},
    "RNDR-USD": {"label": "STX/USDT", "dec": 3},
    "HYPE-USD": {"label": "ARB/USDT", "dec": 4}
}
