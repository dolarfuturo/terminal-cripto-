...
st.markdown("""
    ...
    .w-target { width: 10%; text-align: center; font-size: 12px; font-weight: 800; border-radius: 4px; }
    ...
    .bar-amarela { background-color: #FFFF00 !important; color: #000 !important; box-shadow: 0 0 10px #FFFF00; }
    .bar-laranja { background-color: #FFA500 !important; color: #000 !important; box-shadow: 0 0 10px #FFA500; }
    ...
    .delta-price { font-size: 8px; display: block; font-weight: 400; }
    </style>
                ...
                try:
                    ...
                    st.markdown(f"""
                        <div class="row-container">
                            ...
                            <div class="w-target {h10 if change > 0 else ''}" style="color:#FF0000;">{v10:.{prec}f}<span class="delta-price">+{v10-open_p:.{prec}f}</span></div>
                            ...
                            <div class="w-target {h10 if change < 0 else ''}" style="color:#00FF00;">{c10:.{prec}f}<span class="delta-price">-{open_p-c10:.{prec}f}</span></div>
